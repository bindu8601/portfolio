  ...
  const contactData = [
    {
      ...
      title: 'Email',
      value: 'bindueppalapalle@gamil.com'
    },
    {
      ...
      title: 'Linkedin',
      value: 'https://www.linkedin.com/in/bindu8601/'
    },
    {
      ...
      title: 'Github',
      value: 'https://github.com/bindu8601'
    }
  ];
      ...
      <div class="contact container">
        ...
        <div class="contact-items">
          {contactData.map((item, index) => (
            <a href={item.value} class="contact-item" key={index}>
              <div class="icon">
